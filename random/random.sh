...
stress()
{
    ...
    echo ./fio --filename=/$target --rw=randwrite --bs=4k --iodepth=32 --name=4k_randwrite_QD32 ${para_line} | tee -a $output
    ./fio --filename=/$target --rw=randwrite --bs=4k --iodepth=32 --name=4k_randwrite_QD32 ${para_line} | tee -a $output
