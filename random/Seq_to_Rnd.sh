...
#./fio --filename=/dev/$target --rw=write --bs=1048576 --iodepth=32 --numjobs=1 --size=100% --name=100%Seq_Write_1M --norandommap --direct=1 --refill_buffers --ioengine=libaio --minimal>>100%Seq_Write_1M.log

#./fio --filename=/dev/$target --rw=write --bs=1048576 --iodepth=32 --numjobs=1 --size=100% --name=100%Seq_Write_1M --norandommap --direct=1 --refill_buffers --ioengine=libaio --minimal>>100%Seq_Write_1M.log
./fio --filename=/dev/$target --rw=write --bs=1048576 --iodepth=32 --time_based --size=100% --name=100%Seq_Write_1M --norandommap --direct=1 --refill_buffers --ioengine=libaio --minimal>>100%Seq_Write_1M.log
...
echo "Name,Read_IOPS,Write_IOPS,Total_IOPS,Read_BW(KB),Write_BW(KB),Total_BW(KB),Read_lantency(us),Write_lantency(us),Total_lantency(us)" >> 100%Seq_Write_1M.csv
#./fio --filename=/dev/$target --rw=write --bs=1048576 --iodepth=32 --numjobs=1 --size=50% --name=100%Seq_Write_1M --norandommap --direct=1 --refill_buffers --ioengine=libaio --minimal>>100%Seq_Write_1M.log

#./fio --filename=/dev/$target --rw=write --bs=1048576 --iodepth=32 --numjobs=1 --size=50% --name=100%Seq_Write_1M --norandommap --direct=1 --refill_buffers --ioengine=libaio --minimal>>100%Seq_Write_1M.log
./fio --filename=/dev/$target --rw=write --bs=1048576 --iodepth=32 --time_based --size=50% --name=100%Seq_Write_1M --norandommap --direct=1 --refill_buffers --ioengine=libaio --minimal>>100%Seq_Write_1M.log
tail -n1 100%Seq_Write_1M.log| awk -F ";" '{printf "%s,%d,%d,%d,%d,%d,%d,%d,%d,%d\n","'100%Seq_Write_1M'",$8,$49,$8+$49,$7,$48,$7+$48,$40,$81,$40+$81}' >> 100%Seq_Write_1M.csv
...
#./fio --filename=/dev/$target --rw=randwrite --bs=1048576 --iodepth=32 --numjobs=1 --size=70% --name=100%Random_Write_1M --norandommap --direct=1 --refill_buffers --ioengine=libaio --minimal>>100%Random_Write_1M.log

#./fio --filename=/dev/$target --rw=randwrite --bs=1048576 --iodepth=32 --numjobs=1 --size=70% --name=100%Random_Write_1M --norandommap --direct=1 --refill_buffers --ioengine=libaio --minimal>>100%Random_Write_1M.log
./fio --filename=/dev/$target --rw=randwrite --bs=1048576 --iodepth=32 --time_based --size=70% --name=100%Random_Write_1M --norandommap --direct=1 --refill_buffers --ioengine=libaio --minimal>>100%Random_Write_1M.log
